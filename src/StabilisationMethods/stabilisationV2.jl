...
function stabilise!(points,faces,n,v,zc::Zinchenko2013,constraint!; op=:optim)
    if op==:optim
        stabiliseV2Optim!(points,faces,n,v,zc,constraint!)
    elseif op===:zinchenko
        stabiliseV2!(points,faces,n,v,zc,constraint!)
    else
        error("Your requested method is not available")
    end
end

function stabiliseV2Optim!(points,faces,n,v,zc::Zinchenko2013,constraint!)
...
function stabiliseV2!(points,faces,n,v,zc::Zinchenko2013,constraint!)
